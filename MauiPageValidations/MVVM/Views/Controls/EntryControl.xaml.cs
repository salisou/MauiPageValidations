...
namespace MauiPageValidations.MVVM.Views.Controls;
...
public partial class EntryControl : ContentView
{
    ...
    #region Title {binding Title}
    public static readonly BindableProperty EntryTitleProperty = BindableProperty.Create(nameof(EntryTitle),
                                                                                         typeof(string),
                                                                                         typeof(EntryControl),
                                                                                         string.Empty);
    ...
    #endregion Title {binding Title}

    #region SmartText {Binding text}
    ...
    #endregion SmartText {Binding text}
